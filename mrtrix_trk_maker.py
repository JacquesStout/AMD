...
root= '++++/mretrix_amd/'
orig_subj_path = '++++/mretrix_amd/root/'
...
os.system('/Applications/ANTS/ImageMath 3 ' + csf_nii_gz + ' ThresholdAtMean '+ b0_orig + ' 10')
os.system('/Applications/ANTS/ImageMath 3 ' + csf_nii_gz + ' MD '+ csf_nii_gz + ' 1')
os.system('/Applications/ANTS/ImageMath 3 ' + csf_nii_gz + ' ME '+ csf_nii_gz + ' 1')



os.system('/Applications/ANTS/ImageMath 3 ' + mask_nii_gz + ' - '+ mask_mrtrix_nii +  ' '+ csf_nii_gz)
os.system('/Applications/ANTS/ThresholdImage 3 ' + mask_nii_gz + ' '+ mask_nii_gz +  ' 0.0001 1 1 0')
os.system('/Applications/ANTS/ImageMath 3 ' + mask_nii_gz + ' ME '+ mask_nii_gz + ' 1')
os.system('/Applications/ANTS/ImageMath 3 ' + mask_nii_gz + ' MD '+ mask_nii_gz + ' 1')
...
label_path_orig = orig_subj_path +subj+'_subjspace_labels.nii.gz'
...
label_nii_order  = label_nii_order.astype(int)
...
#os.system('mrview '+ fa_mif + ' -overlay.load '+ parcels_mif) 
